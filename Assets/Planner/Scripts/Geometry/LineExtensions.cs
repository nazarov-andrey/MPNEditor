...
namespace Planner.Geometry
{
    public static class LineExtensions
    {
        ...
        public static bool Intersects (this Line line1, Line line2, out Vector2 intersection)
        {
        ...
        public static Vector2 ProjectPoint (this Line line, Vector2 point, Vector2 direction)
        {
            ...
            Vector2 cross;
            if (!line.Intersects (projectLine, out cross))
        ...
        public static bool ContainsPoint (this Line line, Vector2 point)
        {
            return Mathf.Approximately (line.Calculate (point), 0f);
        }
    }
}